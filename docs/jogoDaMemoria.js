class JogoDaMemoria{
    ...
    inicializar(){
        ...
        this.tela.configurarBotaoMostrarTudo(this.mostrarHeorisEscondidos.bind(this))
    }
   ...
   async embaralhar(){
    ...
    mostrarHeorisEscondidos(){
        //vamos pegar todos herois da tela e colocar seus respectivos valor correto
